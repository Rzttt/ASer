/*!
* MediaElement.js
* HTML5 <media> and <audio> shim and player
...
*
*/var mejs=mejs||{};mejs.version="2.9.1";mejs.meIndex=0;mejs.plugins={silverlight:[{version:[3,0],types:["media/mp4","media/m4v","media/mov","media/wmv","audio/wma","audio/m4a","audio/mp3","audio/wav","audio/mpeg"]}],flash:[{version:[9,0,124],types:["media/mp4","media/m4v","media/mov","media/flv","media/x-flv","audio/flv","audio/x-flv","audio/mp3","audio/m4a","audio/mpeg","media/youtube","media/x-youtube"]}],youtube:[{version:null,types:["media/youtube","media/x-youtube"]}],vimeo:[{version:null,types:["media/vimeo"]}]};
 ...
 * http://mediaelementjs.com/
 *
 * Creates a controller bar for HTML5 <media> add <audio> tags
